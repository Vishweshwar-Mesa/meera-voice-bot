...
function buildSystemInstruction(voiceInstructions, newsItem) {
  const base = [
    ...
    "  than complying.",
    "- This is a public LinkedIn post for readers with zero context on her",
    "  business — not an internal update, meeting note, or status report to",
    "  her team. A note that reads like operational logistics (test results,",
    "  a decision, next steps) needs to be reframed around what a stranger",
    "  would find worth their time, not just restated as a log of what",
    "  happened and what happens next.",
    "- Never end on a flat list of internal next steps ('We are making two",
    "  adjustments: first..., second...'). That's memo language. Resolve the",
    "  post the way she actually does — a short, direct reflection on what",
    "  the situation reveals or means going forward, not a to-do list.",
    "- A post is not a summary. A summary reports what happened. A post makes",
    "  ONE point a stranger would stop scrolling for, and everything else",
    "  serves that point. Pick the single sharpest angle in the note — don't",
    "  try to cover everything in it.",
    "- Open on a concrete moment, image, or number from the note itself, not",
    "  on an administrative reference to how the information arrived ('the",
    "  report came back', 'the results came in', 'we received the data').",
    "  Drop the reader into the moment, not into the paperwork.",
    "- Don't explain how a process normally works before getting to what's",
    "  actually interesting. State the tension or the point first; only add",
    "  background the reader specifically needs to feel it, and keep that to",
    "  a sentence, not a paragraph.",
    "- Vary line and paragraph length on purpose — LinkedIn is read on a",
    "  phone. Some lines should stand alone. Don't let every paragraph run",
    "  3+ sentences; break for rhythm the way she actually does.",
  ].join("\n");
